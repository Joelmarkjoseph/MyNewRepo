...
if inter==False:
        ...
        if st=='selected':
            if ans==False:
                ...
                if int(amount)>sacblnc:
                    ...
                    messagebox.showinfo("Success!", "Money Sent Successfully!!", parent=window)
    ...
    def aboutweb():
        ...
        webbrowser.open('file:///D:/VITSCHOOL/My%20First%20Website%20Details(All%20about%20JMJ)%20000webhost/Firstsublimehtml.html')
    ...
    def mainf():
        ...
        Button(command=aboutweb,text=" About the Developer ",font=("Arial Rounded MT Bold",15),fg='blue',bg='white').place(x=1250,y=50)
        image = Image.open("C:\\Users\\Joel\\Desktop\\LITEPAY\\blue.png")
